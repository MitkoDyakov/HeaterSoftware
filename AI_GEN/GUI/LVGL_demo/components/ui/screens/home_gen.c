...
lv_obj_t * home_create(void)
{
    ...
    lv_obj_set_style_bg_color(row_0, lv_color_hex(0xb36a6a), 0);
    ...
    lv_obj_set_height(column_0, 135);
    ...
    lv_obj_set_style_bg_color(row_1, lv_color_hex(0x2aff7c), 0);
    ...
    lv_obj_set_style_margin_ver(lv_label_0, 12, 0);
    ...
    lv_obj_set_style_bg_opa(row_4, 0, 0);
    ...
    lv_obj_set_style_text_font(lv_label_2, font_temp, 0);
    lv_obj_set_width(lv_label_2, lv_pct(100));
    lv_obj_set_height(lv_label_2, 55);
    lv_obj_set_style_text_align(lv_label_2, LV_TEXT_ALIGN_CENTER, 0);
    lv_label_set_text(lv_label_2, "29°");
    ...
    lv_obj_set_height(lv_label_3, 55);
    ...
    lv_obj_t * lv_label_6 = lv_label_create(column_11);
    lv_obj_set_style_text_font(lv_label_6, font_temp, 0);
    lv_obj_set_width(lv_label_6, lv_pct(100));
    lv_obj_set_height(lv_label_6, 55);
    lv_obj_set_style_text_align(lv_label_6, LV_TEXT_ALIGN_CENTER, 0);
    lv_label_set_text(lv_label_6, "30°");
    ...
    lv_obj_t * lv_label_7 = lv_label_create(row_11);
    lv_obj_set_style_text_font(lv_label_7, font_status, 0);
    lv_obj_set_style_text_line_space(lv_label_7, -8, 0);
    lv_label_set_text(lv_label_7, lv_tr("STOP"));
    lv_obj_set_style_text_align(lv_label_7, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_margin_ver(lv_label_7, 5, 0);
    lv_obj_set_style_margin_left(lv_label_7, 6, 0);
    lv_label_set_long_mode(lv_label_7, LV_LABEL_LONG_MODE_WRAP);
    lv_obj_set_height(lv_label_7, 75);
    lv_obj_set_width(lv_label_7, 13);
