...
#define BUTTON_LEFT_TOP        35
#define BUTTON_LEFT_CENTER     40
#define BUTTON_LEFT_BOTTOM     41
#define BUTTON_RIGHT_TOP       42
#define BUTTON_RIGHT_CENTER    47
#define BUTTON_RIGHT_BOTTOM    48
