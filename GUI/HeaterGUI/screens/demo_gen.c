...
lv_obj_t * demo_create(void)
{
    ...
    lv_obj_bind_state_if_eq(lv_obj_1, &btn_left_1, LV_STATE_CHECKED, 1);
    ...
    lv_obj_bind_state_if_eq(lv_obj_2, &btn_left_2, LV_STATE_CHECKED, 1);
    ...
    lv_obj_bind_state_if_eq(lv_obj_3, &btn_left_3, LV_STATE_CHECKED, 1);
    ...
    lv_obj_bind_state_if_eq(lv_obj_4, &btn_right_1, LV_STATE_CHECKED, 1);
